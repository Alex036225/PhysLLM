...
class BaseLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # For example, an item path could be /path/to/cache/501_input0.npy
    ...
    def load_preprocessed_data(self):
        ...
        # Historical experiments used alternate file lists here. Keep the same
        # file list by default in the public release.
