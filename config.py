...
_C.TRAIN.DATA.MULTI_SOURCE.SOURCE_PATHS = CN(new_allowed=True)
...
_C.MODEL.LLM = None
_C.MODEL.MLLM = None
_C.MODEL.CHECKPOINTS = CN()
_C.MODEL.CHECKPOINTS.FACE_ENCODER = ''
_C.MODEL.CHECKPOINTS.VIDEO_ENCODER = ''

# -----------------------------------------------------------------------------
# Model Settings for MDNet
# -----------------------------------------------------------------------------
_C.MODEL.MDNET = CN()
_C.MODEL.MDNET.PARAMS = CN()
_C.MODEL.MDNET.PARAMS.FEATURE_DIM = 256
_C.MODEL.MDNET.PARAMS.LATENT_DIM = 64
_C.MODEL.MDNET.PARAMS.HIDDEN_DIM = 256
_C.MODEL.MDNET.PARAMS.K_STEPS = 10
_C.MODEL.MDNET.PARAMS.K_LR = 0.1
